...
@section('page_title')
    {{ __('menu.suivimanag')}} | www.anzvergure.com
@stop
                ...
                <article class="vertical-item post type-post status-publish format-standard has-post-thumbnail box">
                    ...
                    <div class="item-media post-thumbnail">
                        <div class="embed-responsive- embed-responsive-3by2-">
                            <img src="{{asset('images/offermanagement.jpg')}}" alt="{{ __('menu.suivimanag') }}" title="{{ __('menu.suivimanag') }}">
                        </div>
                    </div>
                    ...
                    <div class="item-content">
                        <div class="entry-content text-justify">
                            <p>
                                {{ __('offermanagement.texte') }}
                            </p>

                            <ul class="list1">
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offermanagement.li_1') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offermanagement.li_2') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offermanagement.li_3') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offermanagement.li_4') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offermanagement.li_5') }}
                                </li>
