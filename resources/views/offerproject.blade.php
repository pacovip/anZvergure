...
@section('page_title')
    {{ __('menu.suiviproj')}} | www.anzvergure.com
@stop
                ...
                <article class="vertical-item post type-post status-publish format-standard has-post-thumbnail box">
                    ...
                    <div class="item-media post-thumbnail">
                        <div class="embed-responsive- embed-responsive-3by2-">
                            <img src="{{asset('images/offerproject.jpg')}}" alt="{{ __('menu.suiviproj') }}" title="{{ __('menu.suiviproj') }}">
                        </div>
                    </div>
                    ...
                    <div class="item-content">
                        <div class="entry-content text-justify">
                            <p>
                                {{ __('offerproject.texte') }}
                            </p>

                            <ul class="list1">
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_1') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_2') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_3') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_4') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_5') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_6') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_7') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_8') }}
                                </li>
                                <li class="pb-2">
                                    <i class="color-main fa fa-check"></i>
                                    {{ __('offerproject.li_9') }}
                                </li>
